<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <x-dashboard.sideList :active="request()->routeIs('dashboard.categories.*')" title="Categories" icon="fa-solid fa-layer-group" :href="route('dashboard.categories.index')" />

            <x-dashboard.sideList :active="request()->routeIs('dashboard.hightlight.*')" title="Hightlight Banner" icon="fas fa-highlighter" :href="route('dashboard.hightlight.index')" />

            <x-dashboard.sideList :active="request()->routeIs('dashboard.orders.*')" title="Orders Product" icon="fa-solid fa-boxes-stacked" :href="route('dashboard.orders.index')" />
