                        ...
                        <div class="swiper-slide relative">
                            ...
                            <div class="absolute inset-0 bg-[#00000048] px-6 md:px-10 flex flex-col justify-end pb-10">
                                ...
                                <div class="w-80 md:w-200 text-start line-clamp-3 mb-20 lg:mb-30">
                                    <p class="font-bold text-sm md:text-lg text-primary">
                                        {{ $slider->product->category->title ?? '' }}</p>
                                    <h3 class="font-bold text-2xl lg:text-4xl text-slate-200">{{ $slider->title }}</h3>
                                </div>
                                @if ($slider->btn_detail)
            ...
            <div class="flex flex-col md:flex-row h-full">
                ...
                <div class="p-5 w-full md:w-3/5 h-full mt-13 md:mt-50">
                    <div class="w-4/5 line-clamp-3">
                        <h3 class="text-2xl md:text-4xl truncate text-white font-heading font-bold">
                            {{ $hightlight->title ?? '' }}
                        </h3>
                        <p class="text-white mt-2 text-[13px] md:text-[15px] text-ellipsis">
                            {{ $hightlight->desc ?? '' }}
                        </p>
                    </div>
                    @if ($hightlight->btn_detail)
