<div>
    <div class="my-9 flex h-screen">
        ...
        <div class="w-full md:w-1/2 lg:w-2/5 h-full p-10 md:p-15 ld:p-20 md:px-18 lg:px-24">
            ...
            <form class="max-w-md mt-10 mx-auto mb-7">
                ...
                <button type="submit"
                    class="text-white bg-primary hover:bg-[#980e0e] focus:ring-4 focus:outline-none focus:ring-primary font-medium rounded-sm text-[16px] w-full  px-5 py-3.5 text-center">Masuk</button>
                <a href="" class="border-2 border-gray-400 mt-3 w-full px-5 py-3.5 text-center text-slate-800 font-medium rounded-sm text-[16px] flex items-center justify-center gap-2 hover:bg-slate-800 hover:text-white transition-all duration-500">
                    <img src="{{ asset('assets/images/logoGoogle.png') }}" alt="Google" class="w-5 h-5"> Masuk Dengan Google
                </a>
            ...
            <p class="text-gray-500 font-normal text-center mt-2">Belum punya akun? <a href="{{ route('auth.signUp') }}" class="ms-3 font-semibold hover:text-primary transition-all" wire:navigate>Sign Up</a></p>
