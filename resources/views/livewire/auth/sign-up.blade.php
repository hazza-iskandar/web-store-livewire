<div>
    ...
    <div class="my-9 flex h-screen">
        ...
        <div class="w-full md:w-1/2 lg:w-2/5 h-full p-10 md:p-15 ld:p-20 md:px-18 lg:px-24">
            ...
            <form class="max-w-md mt-10 mx-auto" wire:submit="register">
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" id="username" wire:model="username" wire:focus="resetField('username')"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-primary peer @error('username')  @enderror"
            ...
            <p class="text-gray-500 font-normal text-center mt-4">Sudah punya akun? <a href="{{ route('login') }}"
