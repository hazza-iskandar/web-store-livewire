<div>
    ...
    <div class="p-4 sm:ml-64">
        <!-- Header -->
        <x-dashboard.breadcrumb title="All Products" :items="[['name' => 'Products']]" />
        ...
        <div class="relative overflow-x-auto sm:rounded-lg bg-white">
            <div class="flex flex-col lg:flex-row items-center justify-between space-y-3 lg:space-y-0 lg:space-x-4 mb-3">
                <div class="grid md:grid-cols-5 gap-2 w-full">
                    <div class="relative">
            ...
            <div class="flex my-3 justify-between" x-data="{ openDeleteModal: false }">
                ...
                <div x-data="{ openModalCreate: false }">
                    ...
                    <x-modal2 show="openModalCreate" class="w-160">
                        <h2 class="text-xl font-semibold mb-4 text-gray-700 text-center">Tambah Product
                        </h2>
                        ...
                        <form wire:submit="storeProduct" class="space-y-6">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-start mb-2 text-sm font-medium text-gray-700">Harga</label>
                                ...
                                <div>
                                    <label class="block text-start mb-2 text-sm font-medium text-gray-700">Stok</label>
                            ...
                            <div class="my-2 mb-6">
                                <div>
                                    ...
                                    <textarea wire:model="desc"
                                        class="border border-gray-300 outline-none text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 h-10 md:h-50"
                                ...
                                <div class="space-y-4 flex gap-3">
                                    ...
                                    <div class="w-full my-3">
                                        <label
                                            class="mb-2 text-sm font-medium text-gray-700 hidden md:block">Thumbnail</label>
                                        <label
                                            ...
                                            <div class="flex flex-col items-center space-y-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">Pilih Thumbnail</span>
                                                <span class="text-xs text-gray-400 hidden md:block">PNG, JPG, JPEG •
                                                    Maks 2MB</span>
                                            </div>
                                    ...
                                    <div class="w-full my-3">
                                        <label
                                            class="mb-2 text-sm font-medium text-gray-700 hidden md:block">Gambar
                                            Slider</label>
                                        <label
                                            class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                            <div class="flex flex-col items-center space-y-1">
                                                <i class="fa-solid fa-images text-3xl text-primary"></i>
                                                <span class="text-sm text-gray-600 font-medium">Upload Slider</span>
                                                <span class="text-xs text-gray-400 hidden md:block">Dapat pilih banyak
                                                    file</span>
                                            </div>
                                            <input type="file" wire:model.live="images" multiple class="hidden" />
                                        </label>
                                        @error('images')
                                            <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                        @enderror
                    ...
                    <x-dashboard.table.tableTbody>
                        @forelse ($products as $index => $product)
                            <tr>
                                ...
                                <x-dashboard.table.row class="w-30 p-3">
                                    <span
                                        class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm">{{ $product->status }}</span>
                                </x-dashboard.table.row>
                                <x-dashboard.table.row class="w-30 p-3">
                                    @if ($product->stock >= 1)
                                        <span
                                    ...
                                    <form wire:submit="updateProduct({{ $product->id }})" class="space-y-6">
                                        ...
                                        <div class="my-2 mb-6">
                                            ...
                                            <div class="space-y-4 flex gap-3">
                                                ...
                                                <div class="w-full my-3">
                                                    <label
                                                        class="hidden md:block mb-2 text-sm font-medium text-gray-700">Thumbnail</label>
                                                    <label
                                                        class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                                        <div class="flex flex-col items-center space-y-1">
                                                            <i class="fa-solid fa-image text-3xl text-primary"></i>
                                                            <span class="text-sm text-gray-600 font-medium">Pilih
                                                                Thumbnail</span>
                                                            <span class="text-xs text-gray-400 hidden md:block">PNG, JPG, JPEG • Maks
                                                                2MB</span>
                                                        </div>
                                                ...
                                                <!-- Multi Image Upload -->
                                                <div class="w-full my-3">
                                                    <label class="hidden md:block mb-2 text-sm font-medium text-gray-700">Gambar
                                                        Slider</label>
                                                    <label
                                                        class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                                        <div class="flex flex-col items-center space-y-1">
